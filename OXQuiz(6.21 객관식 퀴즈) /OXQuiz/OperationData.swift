...
extension Color {
    ...
    static let topBarColor = Color(hex: 0xFFEEBB)
    static let bgColor1 = Color(hex: 0x99DBF5)
    static let bgColor2 = Color(hex: 0xA7ECEE)
    static let bgColor3 = Color(hex: 0x9AC5F4)
    static let bgColor4 = Color(hex: 0xFFE7CC)
    static let bgColor5 = Color(hex: 0xF8CBA6)
    static let bgColor6 = Color(hex: 0x86E5FF)
    
    static var optionRandom: Color {
        get {
            let randomArray:[Color] = [.bgColor1,.bgColor2,.bgColor3,.bgColor4,.bgColor5, bgColor6]
    ...
    static var random: Color {
        get {
            let randomArray:[Color] = [.mavueColor,.hotPinkColor,.lightBlueColor,.lightPinkColor,.skyBlueColor]
...
func calcNum(_ num1:Int,_ num2: Int,_ ops: String) -> Double {
    ...
    case "/":
        resultDou = Double(num1) / Double(num2)
    case "-":
        resultDou = Double(num1 - num2)
    case "+":
        resultDou = Double(num1 + num2)
